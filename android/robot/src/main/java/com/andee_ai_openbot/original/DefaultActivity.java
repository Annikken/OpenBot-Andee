...
import com.andee_ai_openbot.customview.OverlayView;
import com.andee_ai_openbot.env.BorderedText;
...
import com.andee_ai_openbot.tracking.MultiBoxTracker;
...
import com.andee_ai_openbot.tflite.Autopilot;
import com.andee_ai_openbot.tflite.Detector;
...
public class DefaultActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  protected void processImage() {
    ...
    final boolean SAVE_PREVIEW_BITMAP =
        logMode.equals(Enums.LogMode.ALL_IMGS) || logMode.equals(Enums.LogMode.PREVIEW_IMG);
    final boolean SAVE_CROP_BITMAP =
        logMode.equals(Enums.LogMode.ALL_IMGS) || logMode.equals(Enums.LogMode.CROP_IMG);
  ...
  public boolean dispatchGenericMotionEvent(MotionEvent event) {
    ...
    if (!networkEnabled) {
      ...
      if ((event.getSource() & InputDevice.SOURCE_JOYSTICK) == InputDevice.SOURCE_JOYSTICK
          ...
          && controlMode == Enums.ControlMode.GAMEPAD) {
