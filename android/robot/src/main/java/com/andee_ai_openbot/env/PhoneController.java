...
import com.andee_ai_openbot.customview.AutoFitSurfaceGlView;
import com.andee_ai_openbot.customview.WebRTCSurfaceView;
...
public class PhoneController {
  ...
  private void createAndSetView(Context context) {
    if (videoServer instanceof WebRtcServer) {
      view = new WebRTCSurfaceView(context);
    } else if (videoServer instanceof RtspServer) {
      view = new AutoFitSurfaceGlView(context);
    }
    if (view != null) {
