...
import com.andee_ai_openbot.customview.AutoFitSurfaceView;
import com.andee_ai_openbot.customview.AutoFitTextureView;
import com.andee_ai_openbot.utils.AndGate;
import com.andee_ai_openbot.utils.ConnectionUtils;
import com.andee_ai_openbot.utils.DelayedRunner;
  ...
  public void sendServerUrl() {
    BotToControllerEventBus.emitEvent(
        ConnectionUtils.createStatus(
            "VIDEO_SERVER_URL", "rtsp://" + ConnectionUtils.getIPAddress(true) + ":" + PORT
