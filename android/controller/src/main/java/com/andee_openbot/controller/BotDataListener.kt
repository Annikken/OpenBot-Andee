...
object BotDataListener {
    ...
    fun init() {
        val dataReceived: com.andee_openbot.controller.IDataReceived = object : com.andee_openbot.controller.IDataReceived {
            override fun dataReceived(command: String?) {
                ...
                for (key in statusValues.keys()) {
                    ...
                    */
                    com.andee_openbot.controller.StatusEventBus.emitEvent(key, value)
                }
            }
        }

        com.andee_openbot.controller.ConnectionSelector.getConnection().setDataCallback(dataReceived)
    }
}