...
import com.andee_openbot.controller.customComponents.DualDriveSeekBar
import com.andee_openbot.controller.customComponents.VideoViewWebRTC
...
class ControllerActivity : /*AppCompat*/
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.andee_openbot.controller.ConnectionSelector.init(this)
        ...
        com.andee_openbot.controller.BotDataListener.init()
...

            {
                ...
                when (it) {
                    ...
                    LocalEventBus.ProgressEvents.TemporaryConnectionProblem -> {
                        screenSelector.hideControls()
                        com.andee_openbot.controller.ConnectionSelector.getConnection().connect(this)
                    }
    ...
    override fun onPause() {
        super.onPause()
        com.andee_openbot.controller.ConnectionSelector.getConnection().disconnect()
    }
    ...
    override fun onResume() {
        ...
        com.andee_openbot.controller.ConnectionSelector.getConnection().init(this)
        com.andee_openbot.controller.ConnectionSelector.getConnection().connect(this)
    }
